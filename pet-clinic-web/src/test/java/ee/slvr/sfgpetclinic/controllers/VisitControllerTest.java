...
import ee.slvr.sfgpetclinic.services.PetService;
import ee.slvr.sfgpetclinic.services.VisitService;
...
class VisitControllerTest {
    ...
    void setUp() {
        ...
        visitsUri = visitsUriTemplate.expand(uriVariables); //need attention
